The Domain Model for the Smart Parking Management System illustrates the conceptual entities and structural rules of a real-world parking environment. 
At the structural level, a ParkingLot is composed of one or more Floors, which consist of multiple ParkingSlots. This hierarchy ensures a facility
must have physical capacity to exist in the system.
...
supporting multiple payment transactions (partial or split) at exit. All financial attributes use the double data type for decimal precision. By using these specific multiplicities,
the model provides a robust foundation for tracking both real-time occupancy and long-term financial history.
